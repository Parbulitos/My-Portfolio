    ...
    return(
        <div className="w-full px-6 py-2 flex items-center bg-emerald-500 border-solid bg-opacity-75 drop-shadow-darker">
            <div className="w-fit drop-shadow-dark rounded-full ">
                <img src={ProfileImg} className="w-18 aspect-square border-2 drop-shadow-md rounded-full hover:cursor-pointer hover:scale-small transition-transform duration-medium" alt="Error loading resource"/>
            </div>
